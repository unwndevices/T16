...
struct PinDefinitions {
    ...
    static constexpr uint8_t COM = 8;
...
struct MultiplexerPins {
    ...
    static constexpr uint8_t com_pins[1] = {PinDefinitions::COM};
    static constexpr uint8_t num_mux = 1;
};
...
template<>
struct HardwarePinout<HardwareVariant::T16> {
    using Pins = T16::PinDefinitions;
    using Mux = T16::MultiplexerPins;
    using Touch = T16::TouchSliderPins;
    using Midi = T16::MidiPins;
    using Control = T16::ControlPins;
    using Led = T16::LedPins;
};
